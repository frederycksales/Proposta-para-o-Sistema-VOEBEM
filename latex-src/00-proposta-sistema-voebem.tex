...
\usepackage{listings} % Para blocos de código (lstlisting)
\usepackage{enumitem} % Para listas numeradas e com marcadores
\graphicspath{{../assets/}}
...
% Capítulo 1
% ----------------------------------------------------------
\include{01-arquitetura-c4}
% ----------------------------------------------------------
% Capítulo 2
% ----------------------------------------------------------
\include{02-deploy-resiliencia}
% ----------------------------------------------------------
% Capítulo 3
% ----------------------------------------------------------
\include{03-confiabilidade-feedback}
...
% ----------------------------------------------------------
\begin{anexos}
\include{99-anexo-A-ER-dbml}
\end{anexos}

% ---
% Bibliografia (COMENTADO PARA NÃO RENDERIZAR)
% ---
